...
const {criarTexto, erroComandoMsg, consoleErro, obterNomeAleatorio} = require("../lib/util")
...
module.exports = utilidades = async(client,message) => {
    try{
        ...
        case '!meusdados':
            ...
            var nomeUsuario = pushname || `Ainda não obtido`, resposta = criarTexto(msgs_texto.utilidades.meusdados.resposta_geral, tipoUsuario, nomeUsuario, dadosUsuario.comandos_total)
        ...
        case '!ajuda': 
            ...
            var dadosResposta = '', nomeUsuario = pushname || "Ainda não obtido"
            ...
            dadosResposta += `═════════════════\n`
            var menuResposta = menuAjuda(isGroupAdmins,isGroupMsg)
