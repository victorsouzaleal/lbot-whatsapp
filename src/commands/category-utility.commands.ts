...
export async function encurtarCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.encurtar.msgs.reply, url), message.wa_message, {expiration: message.expiration})
}
...
export async function upimgCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.upimg.msgs.reply, imageUrl), message.wa_message, {expiration: message.expiration})
}
...
export async function filmesCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.filmes.msgs.reply, movieTrendings), message.wa_message, {expiration: message.expiration})
}
...
export async function seriesCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.series.msgs.reply, movieTrendings), message.wa_message, {expiration: message.expiration})
}
...
export async function rbgCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, commandsData.utility.rbg.msgs.wait, message.wa_message, {expiration: message.expiration})
...
export async function tabelaCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.tabela.msgs.reply, replyText), message.wa_message, {expiration: message.expiration})
}
...
export async function ouvirCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, buildText(commandsData.utility.ouvir.msgs.reply, replyText), message.quotedMessage.wa_message, {expiration: message.expiration})
}
...
export async function traduzCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    if (!languageSupported.includes(languageTranslation)){
        await Whatsapp.replyText(client, message.chat_id, commandsData.utility.traduz.msgs.error, message.wa_message, {expiration: message.expiration})
        return
    }
...
export async function qualmusicaCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, commandsData.utility.qualmusica.msgs.wait, message.wa_message, {expiration: message.expiration})
...
export async function qualanimeCommand(client: WASocket, botInfo: Bot, message: Message, group? : Group){
    ...
    await Whatsapp.replyText(client, message.chat_id, commandsData.utility.qualanime.msgs.wait, message.wa_message, {expiration: message.expiration})
