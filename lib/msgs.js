    ...
    return {
        ...
        downloads: {
            play:{
                ...
                erro_pesquisa: "[❗] Houve um erro na pesquisa de videos, verifique se o video é publico, não tem restrição de idade ou precisa estar logado.",
        ...
        grupo: {
            ...
            adms:{
                resposta_titulo: "🤖 Marcando os administradores :\n\n",
                resposta_itens: "➸ @{p1}\n"
            },
            mt:{
        ...
        permissao: {
            ...
            apenas_dono_bot: '[❗] Apenas o dono do BOT pode usar este comando, caso seja o dono verifique se seu número está configurado corretamente no arquivo *.env*',
