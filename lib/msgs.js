const msgs_texto = {
    inicio:{
        ...
        env_atualizado : "✓ Seu .env foi atualizado com novos campos, inicie o bot novamente.",
        ...
        dbgrupos_verificado: "✓ Database de Grupos verificada.",
        dbusuarios_verificado: "✓ Database de Usuarios verificada.",
        dbbot_verificado: "✓ Database do BOT verificada.",
        env_verificado: "✓ ENV verificado.",
    },
    geral: {
    ...
    admin: {
        ...
        bccontatos:{
            anuncio: "[🤖LBOT® - Mensagem para os contatos]\n\n"+
            "{p1}",
            bc_sucesso: "🤖✅ Anúncio feito com sucesso."
        },
        sair:{
