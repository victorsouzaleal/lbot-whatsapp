const msgs_texto = {
    ...
    api: {
        scaleserp: "Houve um erro na API de pesquisa do Imagens, confira se o limite gratuito da chave excedeu ou se ela está configurada.",
        avesapi: "Houve um erro na API de pesquisa do Google, confira se o limite gratuito da chave excedeu ou se ela está configurada.",
