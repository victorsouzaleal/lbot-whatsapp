const msgs_texto = ()=>{
    ...
    utilidades:{
        ...
        img : {
            ...
            erro_api: "[❗] Não encontrei resultados ou houve um erro na API de pesquisa de imagens, tente novamente mais tarde."
        },
        anime:{
    ...
    admin: {
        ...
        limitecomandos:{
            ...
            desativado: "✅ O Limitador de comandos por minuto foi deativado com sucesso",
        },
        r: {
