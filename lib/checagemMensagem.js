...
import {botInfoUpdate, botLimitarComando, botInfo, botVerificarExpiracaoLimite,botLimitarMensagensPv} from '../db-modulos/bot.js'
...
export const checagemMensagem = async (c, messageTranslated) => {
    try {
        const lista_comandos = listarComandos(), msgs_texto = obterMensagensTexto(), botInfoJSON = botInfo()
