...
|- *!doar* - Ajude o dono do bot a comprar coxinha.
...
|
|- *!bcmd [comandos]* - Bloqueia os comandos escolhidos no grupo.
|- *!dcmd [comandos]* - Desbloqueia os comandos escolhidos no grupo.
|
|--------- ☾ ADMINISTRATIVO ☽
|
...
|--------- ☾ ENQUETE ☽
|
|- *!enquete pergunta,opcao1,opcao2..* - Abre uma enquete com uma pergunta e as opçôes.
