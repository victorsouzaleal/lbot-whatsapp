...
function menuAjuda(isGroupAdmin, isGroup){
    //CABEÇALHO DO MENU
    let menu_cabecalho = `
    __| ❣ *🤖 LBOT®* ❣ 
|
...
|- *!fb [link]* - Faz download de um video do Facebook e envia.
|- *!tw [link]* - Faz download de um video/foto do Twitter e envia.
...
|`
    ...
    //RODAPÉ E CRÉDITOS - DEIXEI O BOT LIVRE PARA MODIFICAÇÕES MAS POR FAVOR NÃO REMOVA ESSA PARTE
    //PENSE NO ESFORÇO E TRABALHO DE QUEM DESENVOLVEU E DÊ UMA FORÇA DEIXANDO UMA ESTRELA NO PROJETO, ESTOU SEMPRE MELHORANDO E RESOLVENDO PROBLEMAS.
