...
|>---- ☾ ⚒️ *UTILITÁRIOS* ⚒️☽
|
|- *!voz [idioma] [mensagem]* - Transforma texto em audio, ex: *!voz* pt olá
...
|- *!traduz* [idioma]/[texto] - Traduz um texto para o idioma escolhido, ex: *!traduz* pt/Hi.
...
|- *!vb* @marcarmembro max-votos - Abre uma votação de ban (ex: !vb @pessoa 5)
|- *!vb* - Encerra uma votação de ban.
|
|-- ☾ ENQUETE ☽
|
...
|- *!limitediario* - Ativa o limite diario de comandos por dia
