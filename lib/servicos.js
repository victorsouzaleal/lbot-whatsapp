...
module.exports = {
    ...
    obterPesquisaGoogle: async pesquisa=>{
        try{
            const params = {
                apikey: process.env.API_AVESAPI,
                query: pesquisa,
                type: "web",
                num: 50,
                output: "json",
            ...
            let resultados = await axios.get('https://api.avesapi.com/search', {params}), resposta = []
            resultados = resultados.data.result.organic_results.slice(0,5)
            ...
            consoleErro(msgs_texto.api.avesapi, "SERVIÇO obterPesquisaGoogle")
