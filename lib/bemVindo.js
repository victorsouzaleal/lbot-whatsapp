...
module.exports = bemVindo = async(client,event,g_info)=>{
    if(g_info.bemvindo.status){
        ...
        const fotoParticipante = await client.getProfilePicFromServer(event.who) || path.resolve('media/img/commands/bv/user.jpg')
        ...
        const image = await new Canvas.Welcome()
            ...
            .setBackground(path.resolve('media/img/commands/bv/background.jpg'))
            .toAttachment()
