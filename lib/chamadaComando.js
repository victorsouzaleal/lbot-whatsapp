...
import {botLimitarComando, botInfo, botVerificarExpiracaoLimite,botLimitarMensagensPv} from '../database/bot.js'
        ...
        if(comandoExiste){
            ...
            if(isGroupMsg && (type == MessageTypes.image || type == MessageTypes.video) && grupoInfo.autosticker){
                ...
                if(botInfoJSON.limite_diario.status){
                    ...
                    if(!ultrapassou) await usuariosdb.addContagemDiaria(sender) 
