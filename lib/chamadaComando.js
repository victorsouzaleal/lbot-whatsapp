...
import { criarTexto, guiaComandoMsg, consoleErro, consoleComando } from './util.js'
...
export const chamadaComando = async (c, messageTranslated) => {
    try {
        const lista_comandos = listarComandos(), {prefixo, nome_bot, nome_adm} = obterBotVariaveis(), msgs_texto = obterMensagensTexto(), botInfoJSON = botInfo()
