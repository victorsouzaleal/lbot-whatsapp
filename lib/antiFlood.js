                ...
                if (!isBotGroupAdmins || (await db.grupoInfoAntiFlood(groupId) == undefined)) {
                    ...
                    if(flood) {
                        if(!groupAdmins.includes(sender)) {
                            ...
                            await client.sendTextWithMentions(c,chatId, criarTexto(msgs_texto.geral.resposta_ban, sender.replace("@s.whatsapp.net", ""), msgs_texto.grupo.antiflood.motivo, botInfo().nome), [sender])
                            return false
                        }
                    } 
                }
