...
module.exports = {
    ...
    registrarContagemTodos: async(id_grupo,usuarios)=>{
        for(let usuario of usuarios){
            ...
            await db.contador.asyncInsert({id_grupo,id_usuario: usuario, id_unico, msg:0,imagem:0,gravacao:0,audio:0,sticker:0,video:0,outro:0,texto:0})
        }
    },
    ...
    addContagem: async(id_grupo,id_usuario,tipo_msg)=>{
        switch(tipo_msg){
            case MessageTypes.text || MessageTypes.extendedText:
