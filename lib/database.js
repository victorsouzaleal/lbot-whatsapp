...
module.exports = {
    ...
    registrarGrupo: async(id_grupo, nome, descricao, participantes, admins)=>{
        let cadastro_grupo = {
            id_grupo,
            nome,
            descricao,
    ...
    atualizarGrupo: async(id_grupo, nome, descricao, participantes, admins)=>{  
        await db.grupos.asyncUpdate({id_grupo}, {$set: {nome, descricao, participantes, admins}})
    },
