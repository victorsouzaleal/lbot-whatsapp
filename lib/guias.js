...
export const obterGuias = async () => {
    ...
    return {
        ...
        figurinhas: {
            ...
            `Ex: Envie/responda uma *IMAGEM/VIDEO* com *${prefixo}s 1* - Transforma em sticker circular.\n`+
            `Ex: Envie/responda uma *IMAGEM/VIDEO* com *${prefixo}s 2* - Transforma em sticker arredondado.\n`,
            ssf: cabecalho+
