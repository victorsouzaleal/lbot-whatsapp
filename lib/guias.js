...
module.exports = {
    utilidade : {
        ...
        tw: cabecalho+
        "Ex: *!tw link-video* - Faz download de um video do Twitter pelo link digitado e envia.\n",
        anime:cabecalho+
    ...
    grupo:{
        ...
        destravar: cabecalho+
        "Ex: *!destravar* - Manda destravas váriadas para o grupo, se caso alguém travar.",
        bv: cabecalho+
