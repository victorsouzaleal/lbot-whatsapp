...
module.exports = {
    ...
    figurinhas: {
        s: cabecalho+
        "Ex: Responda/envie uma *imagem* com legenda *!s* - Transforma a imagem que você *respondeu/enviou* em sticker.\n"+
        "Ex: Responda/envie uma *imagem* com *!s* 1 - Transforma a imagem que você *respondeu/enviou* em sticker circular.\n"+
        "*Obs*: Este comando funciona apenas com *IMAGENS*.\n",
        sgif: cabecalho+
        "Ex: Responda/envie um *gif/video* com legenda *!sgif* - Transforma o gif/video que você *respondeu/enviou* em sticker animado.\n"+
        "Ex: Responda/envie um *gif/video* com *!sgif* 1 - Transforma o gif/video que você *respondeu/enviou* em sticker animado com as proporções originais.\n"+
        "Ex: Responda/envie um *gif/video* com *!sgif* 2 - Transforma o gif/video que você *respondeu/enviou* em sticker animado em formato circular.\n"+
    ...
    admin:{
        ...
        usuarios: cabecalho+
        "Uso: *!usuarios* [tipo] - Mostra todos os usuários do tipo digitado.\n"+
        "Ex: *!usuarios* comum - Mostra todos os usuários do tipo *COMUM*\n"+
        ...
        "Ex: *!taxalimite* - Desativa a taxa limite de comandos por usuário.\n",
        ...
        "Ex: *!limitarmsgs* - Desativa o limite de mensagens privadas.\n",
        tipos: cabecalho+
        "Ex: *!tipos* - Exibe os tipos de usuários disponíveis e quantos comandos estão configurados por dia.",
        limpartipo: cabecalho+
        "Uso: *!limpartipo* [tipo] - Transforma todos os usuários do tipo digitado em *COMUM*\n"+
        "Ex: *!limpartipo* vip - Transforma todos os usuários do tipo *VIP* em *COMUM*\n"+
        "*Obs*: Use o *!tipos* para ver os tipos disponíveis de usuários.",
        mudarlimite: cabecalho+
        "Ex: *!mudarlimite* comum 50 - Altera o limite diário de comandos do usuário *COMUM* para 50/dia.\n\n"+
        ...
        "Uso: *!alterartipo* [tipo] @usuario - Altera o tipo do usuário mencionado para o tipo digitado.\n"+
        "Ex: *!alterartipo* vip @usuario - Altera o tipo do usuário mencionado para *VIP*.\n"+
        "Ex: *Responder* com *!alterartipo* comum - Altera o tipo do usuário respondido para *COMUM*.\n"+
        "Ex: *!alterartipo* contribuidor  55219xxxxxxxx - Altera o tipo do usuário do número para *CONTRIBUIDOR*.\n\n"+
        "*Obs*: Use o *!tipos* para ver os tipos disponíveis de usuários.",
        vervips: cabecalho+
