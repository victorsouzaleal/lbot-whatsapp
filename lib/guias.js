...
module.exports = {
    ...
    grupo:{
        ...
        aporno: cabecalho+
        "Ex: *!aporno* - Liga/desliga o anti-pornô em imagens/stickers.\n\n"+
        "*Obs*: A ativação do anti-pornô pode tornar o anti-flood mais lento pois há uma checagem em cada imagem/sticker.",
        mutar: cabecalho+
