...
module.exports = {
    ...
    figurinhas: {
        s: cabecalho+
        "Ex: Envie/responda uma *imagem/gif/video* com *!s* - Transforma em sticker.\n\n"+
        "Ex: Envie/responda uma *imagem/gif/video* com *!s* 1 - Transforma em sticker circular.\n\n"+
        "Ex: Envie/responda uma *imagem/gif/video* com *!s* 2 - Transforma em sticker sem cortar.",
        ssf: cabecalho+
    ...
    downloads: {
        ...
        "Ex: *!ig* link 2 - Faz download do SEGUNDO video/foto do link (em caso do link ter mais de 1 video/foto).",
        img: cabecalho+
    ...
    utilidade : {
        ...
        ouvir: cabecalho+
        "Ex: Responda um áudio com *!ouvir* para transformar em texto.",
        audio: cabecalho+
    ...
    grupo:{
        ...
        blista: cabecalho+
        "Ex: Responda alguém com *!blista* - Adiciona o numero de quem foi respondido a lista negra.\n\n"+
        ...
        adms:  cabecalho+
        "Ex: Responder com *!adms* - Marca todos os *ADMINISTRADORES* em uma postagem.\n\n"+
        "Ex: *!adms* - Marca os *ADMINISTRADORES* do grupo.",
        dono:  cabecalho+
