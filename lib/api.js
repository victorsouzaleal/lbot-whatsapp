    ...
    obterMidiaTiktok : async(url)=>{
        try{
            ...
            var config = {
                ...
                headers: { 
                    'Cookie': '__cfduid=da34f3960c579212cad81b5c1497a16ba1620561221; __cflb=0H28vNadMLAyXKUf1FTkGtPDEbVgZxDvaWonriFbXwZ', 
                    ...data.getHeaders()
                },
                data : data
            };
            ...
            var url_video = $("#download-block > div > a:nth-child(4)").attr("href")
            return url_video
        } catch(err){
