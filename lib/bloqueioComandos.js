...
module.exports = {
    bloquearComandosGrupo: async (usuarioComandos, idGrupo)=>{
        var comandosBloqueados = [], grupoInfo = await socket.getGroupInfoFromDb(idGrupo), respostaBloqueio = msgs_texto.grupo.bcmd.resposta_titulo
    ...
    desbloquearComandosGrupo: async (usuarioComandos, idGrupo)=>{
        var comandosDesbloqueados = [], grupoInfo = await socket.getGroupInfoFromDb(idGrupo), respostaDesbloqueio = msgs_texto.grupo.dcmd.resposta_titulo
    ...
    verificarBloqueioGrupo: async (comando, idGrupo)=>{
        var grupoInfo = await socket.getGroupInfoFromDb(idGrupo)
